...
const settlements = [
    ...
    { id: 14, name: "Hişet Kalesi", lat: 38.313391, lng: 43.109951 },
    { id: 15, name: "Hişet-Hizan Kalesi", lat: 38.270903, lng: 42.647756 },
...
// Domain for the QR codes
const BASE_URL = 'https://la-foa.com';

async function generateQRCodes() {
    console.log(`Generating ${settlements.length} QR codes...`);
    ...
    for (const settlement of settlements) {
        ...
        try {
            await QRCode.toFile(filePath, urlForQR, {
                width: 300,
                margin: 2,
                color: {
                    dark: '#000000',
            ...
            console.log(`Generated: ${fileName} -> ${urlForQR}`);
        } catch (err) {
            console.error(`Error generating QR code for ID ${settlement.id}:`, err);
        }
    }
